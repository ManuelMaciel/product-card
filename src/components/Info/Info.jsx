...
const Info = () => {
  const shoeName = (
    <div className="shoeName">
      ...
      <h3 className="small">Zapatos deportivos para hombres</h3>
    </div>
  );

  const description = (
    <div className="description">
      <h3 className="title">Informacion del producto</h3>
      <p className="text">
      Asegúrate de que la sesión de correr sea cómoda usando este par de zapatos...
      zapatillas de deporte de Nike.
      </p>
    </div>
  );
  ...
  const BuySection = (
    <div className="buy-price">
      <a href="/#" className="buy">
        <i className="fas fa-shopping-cart"></i>Agregar al carro
      </a>
      <div className="price">
